(module
 ...
 (table 5 5 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN12votequchuxin7unstakeEy $_ZN12votequchuxin4initEv $_ZN12votequchuxin10printstakeEy $_ZN12votequchuxin5clearEv)
 (memory $0 1)
 ...
 (data (i32.const 144) "now() \00")
 (data (i32.const 160) "end \00")
 (data (i32.const 176) "nohello \00")
 ...
 (data (i32.const 320) "the vote doesn\'t finish\00")
 (data (i32.const 352) "You don\'t staked CPLE\00")
 (data (i32.const 384) "active\00")
 (data (i32.const 400) "dacincubator\00")
 (data (i32.const 416) "invalid symbol name\00")
 (data (i32.const 448) "unstake CPLE\00")
 ...
 (data (i32.const 752) "Invalid recipient\00")
 (data (i32.const 784) "Invalid token transfer\00")
 (data (i32.const 816) "must be a positive amount\00")
 (data (i32.const 848) "must use CPLE to vote\00")
 (data (i32.const 880) "CPLE vote event between at 2018/11/19 8:0:0 (UTC+8 Beijing) and 2018/11/21 8:0:0.\00")
 (data (i32.const 976) "support\00")
 (data (i32.const 992) "oppose\00")
 (data (i32.const 1008) "Error params content\00")
 (data (i32.const 1040) "Error params amount\00")
 ...
 (export "_ZN12votequchuxin10printstakeEy" (func $_ZN12votequchuxin10printstakeEy))
 ...
 (func $_ZN12votequchuxin10printstakeEy (type $FUNCSIG$vij) (param $0 i32) (param $1 i64)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
